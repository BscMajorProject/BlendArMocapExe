...
bazel-bin/src/mp/detection/general/cpu_tracking_main --calculator_graph_config_file=$pose
# bazel-bin/src/mp/detection/hand_tracking/hand_tracking_cpu --calculator_graph_config_file=$calc
